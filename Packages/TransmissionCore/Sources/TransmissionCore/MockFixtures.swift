    ...
    public static func torrents() -> [Torrent] {
        ...
        return [
            Torrent(
                ...
                secondsDownloading: 14_400,
                secondsSeeding: 0,
                leftUntilDone: Int64(2.24 * Double(giB)),
                sizeWhenDone: Int64(5.9 * Double(giB)),
                files: stubFile(
            ...
            Torrent(
                ...
                pieceSize: 512 * kiB,
                havePieces: 4600,
                options: TorrentOptions(uploadLimited: true, uploadLimitKBps: 800),
                completedAt: ago(hours: 20),
                startedAt: ago(days: 1, hours: 3),
                secondsDownloading: 28_800,
                secondsSeeding: 72_000,
                leftUntilDone: 0,
                sizeWhenDone: Int64(2.3 * Double(giB)),
            ...
            Torrent(
                ...
                startedAt: ago(days: 4),
                secondsDownloading: 36_000,
                leftUntilDone: Int64(11.6 * Double(giB)),
                sizeWhenDone: Int64(14.2 * Double(giB)),
                files: debianFiles(),
                peers: debianPeers(),
